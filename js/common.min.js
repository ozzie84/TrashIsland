...
function initMap(){var e=new google.maps.Map(document.getElementById("map"),{styles:[{elementType:"geometry",stylers:[{color:"#f5f5f5"}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{elementType:"labels.text.stroke",stylers:[{color:"#f5f5f5"}]},{featureType:"administrative.land_parcel",elementType:"labels.text.fill",stylers:[{color:"#bdbdbd"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#ffffff"}]},{featureType:"road.arterial",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#dadada"}]},{featureType:"road.highway",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"transit.line",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#c9c9c9"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]}]});new google.maps.KmlLayer({url:"https://ozzie84.github.io/TrashIsland/TrashMap.kml",map:e})}
!function(e){e(".hamburger").on("click",function(){e(this).toggleClass("open"),e(".header__menu").toggleClass("flex_menu")}),e(window).on("load resize",function(){e(window).outerWidth()<="768"&&(e(".header__menu").removeClass("flex_menu"),e(".hamburger").removeClass("open"))}),e(".phone_mask").mask("+000 0000 0000"),e('header a[href^="#"]').on("click",function(){e("html, body").animate({scrollTop:e(e(this).attr("href")).offset().top-70},1e3)}),e("#form").submit(function(){return e.ajax({type:"POST",url:"mail.php",data:e(this).serialize()}).done(function(){alert("Thanks you for your application. Soon we will contact you")}),!1}),e(window).bind("scroll",function(){e(window).outerWidth()>992&&(e(window).scrollTop()>50?e(".header").addClass("fixed"):e(".header").removeClass("fixed"))}),e(window).on("resize load",function(){e(window).outerWidth()<992&&e(".header").removeClass("fixed")});var o=70;function t(o){var t=e(document).scrollTop();e("header a").each(function(){var o=e(this),a=e(o.attr("href"));a.position().top<=t&&a.position().top+a.height()>t?(e("#menu ul li a").removeClass("active"),o.addClass("active")):o.removeClass("active")})}e(window).on("resize load",function(){e(window).outerWidth()<768&&(o=70===o?50:70)}),e(document).on("scroll",t),e('header a[href^="#"]').on("click",function(a){a.preventDefault(),e(document).off("scroll"),e("header a").each(function(){e(this).removeClass("active")}),e(this).addClass("active");var i=this.hash;$target=e(i),e("html, body").stop(!0).animate({scrollTop:$target.offset().top-o},700,"swing",function(){e(document).on("scroll",t)})})}(jQuery);var tag=document.createElement("script");tag.src="https://www.youtube.com/iframe_api";var playerVideo,firstScriptTag=document.getElementsByTagName("script")[0];function onYouTubeIframeAPIReady(){playerVideo=new YT.Player("playerVideo",{border:"2px solid red",height:"400",width:"800",videoId:"LPFILQmmY9c",controls:0,rel:0,fs:0,loop:1,showinfo:0,modestbranding:1})}firstScriptTag.parentNode.insertBefore(tag,firstScriptTag),onYouTubeIframeAPIReady();