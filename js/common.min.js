...
function initMap(){var e=document.getElementById("map"),l=new google.maps.Map(e,{zoom:15,center:{lat:-25.365,lng:131.044},disableDefaultUI:!0,styles:[{elementType:"geometry",stylers:[{color:"#f5f5f5"}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{elementType:"labels.text.stroke",stylers:[{color:"#f5f5f5"}]},{featureType:"administrative.land_parcel",elementType:"labels.text.fill",stylers:[{color:"#bdbdbd"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#ffffff"}]},{featureType:"road.arterial",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#dadada"}]},{featureType:"road.highway",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"transit.line",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#c9c9c9"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]}]});new google.maps.Marker({position:{lat:-25.365,lng:131.044},map:l}),new google.maps.Marker({position:{lat:-25.364,lng:131.034},map:l}),new google.maps.Marker({position:{lat:-25.366,lng:131.046},map:l}),new google.maps.Marker({position:{lat:-25.366,lng:131.036},map:l})}
!function(e){if(e(".parallax-window").parallax({position:"center bottom"}),navigator.userAgent.match(/(iPod|iPhone|iPad)/))return this.imageSrc&&this.iosFix&&!this.$element.is("img")&&this.$element.css({backgroundImage:"url("+this.imageSrc+")",backgroundSize:"cover",backgroundPosition:this.position}),this;if(navigator.userAgent.match(/(Android)/))return this.imageSrc&&this.androidFix&&!this.$element.is("img")&&this.$element.css({backgroundImage:"url("+this.imageSrc+")",backgroundSize:"cover",backgroundPosition:this.position}),this;e(".hamburger").on("click",function(){e(this).toggleClass("open"),e(".header__menu").toggleClass("flex_menu")}),e(window).on("load resize",function(){e(window).outerWidth()<="768"&&(e(".header__menu").removeClass("flex_menu"),e(".hamburger").removeClass("open"))}),e('.header__menu__items a[href^="#"]').on("click",function(){e("html, body").animate({scrollTop:e(e(this).attr("href")).offset().top},1e3)})}(jQuery);var tag=document.createElement("script");tag.src="https://www.youtube.com/iframe_api";var playerVideo,firstScriptTag=document.getElementsByTagName("script")[0];function onYouTubeIframeAPIReady(){playerVideo=new YT.Player("playerVideo",{border:"2px solid red",height:"400",width:"800",videoId:"RvXkx3IcOi4"})}firstScriptTag.parentNode.insertBefore(tag,firstScriptTag),onYouTubeIframeAPIReady();