...
!function(e){function o(o){var a=e(document).scrollTop();e("header a").each(function(){var o=e(this),t=e(o.attr("href"));t.position().top<=a&&t.position().top+t.height()>a?(e("#menu ul li a").removeClass("active"),o.addClass("active")):o.removeClass("active")})}e(".hamburger").on("click",function(){e(this).toggleClass("open"),e(".header__menu").toggleClass("flex_menu")}),e(window).on("load resize",function(){e(window).outerWidth()<="768"&&(e(".header__menu").removeClass("flex_menu"),e(".hamburger").removeClass("open"))}),e(".phone_mask").mask("+000 0000 0000"),e('header a[href^="#"]').on("click",function(){e("html, body").animate({scrollTop:e(e(this).attr("href")).offset().top-70},1e3)}),e("#form").submit(function(){return e.ajax({type:"POST",url:"mail.php",data:e(this).serialize()}).done(function(){alert("Thanks you for your application. Soon we will contact you")}),!1}),e(window).bind("scroll",function(){e(window).outerWidth()>"992"&&(e(window).scrollTop()>50?(e(".header").addClass("fixed"),e("header").addClass("header-opacity")):(e(".header").removeClass("fixed"),e("header").removeClass("header-opacity")))}),e(window).on("resize load",function(){e(window).outerWidth()<992&&(e(".header").removeClass("fixed"),e("header").removeClass("header-opacity"))}),e(document).on("scroll",o),e('header a[href^="#"]').on("click",function(a){a.preventDefault(),e(document).off("scroll"),e("header a").each(function(){e(this).removeClass("active")}),e(this).addClass("active");var t=this.hash;$target=e(t),e("html, body").stop(!0).animate({scrollTop:$target.offset().top-70},700,"swing",function(){e(document).on("scroll",o)})})}(jQuery);var tag=document.createElement("script");tag.src="https://www.youtube.com/iframe_api";var playerVideo,firstScriptTag=document.getElementsByTagName("script")[0];function onYouTubeIframeAPIReady(){playerVideo=new YT.Player("playerVideo",{border:"2px solid red",height:"400",width:"800",videoId:"LPFILQmmY9c",controls:0,rel:0,fs:0,loop:1,showinfo:0,modestbranding:1})}firstScriptTag.parentNode.insertBefore(tag,firstScriptTag),onYouTubeIframeAPIReady();